...
public:
	...
	static void inserAadAxleNum(AcDbObjectIdArray& sortIds, AcGePoint3d& inputstartpt, AcGePoint3d& inputendpt
		, /*int casenum,*/ int plusorminus ,std::map<AcDbObjectId,AcString>& AxisNumberMap, AcDbDatabase *pDb = acdbCurDwg());
