...
class Connection {
 public:
    ...
    /**
      ...
      *  @var Info::headers
      *  Member 'headers' contains the RequestHeaderFields map
      *  @var Info::timeout
    ...
    // set headers
    void SetHeaders(RestClient::RequestHeaderFields headers);

    // get headers
    RestClient::RequestHeaderFields GetHeaders();
 ...
 private:
    CURL* curlHandle;
    std::string baseUrl;
    RestClient::RequestHeaderFields headerFields;
    int timeout;
    bool followRedirects;
    bool noSignal;
    struct {
